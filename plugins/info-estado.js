...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Alcashop
  ${tradutor.texto1[2]} +528241050228
  ${tradutor.texto1[3]} paypal.me/Alcashopff
  ...
  const Message = {
    document: { url: `https://github.com/Alcaventas/Mama24 },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/Alcaventas/Mama24",
        mediaType: 2,
        previewType: "pdf",
        title: "The Mystic - Bot",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://github.com/Alcaventas/Mama24",
      },
    },
    caption: info,
    footer: wm,
